...
export default function AuthPage() {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setNotification("Welcome back to BetterWithin!")
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (donationAmount) {
        setNotification(`Thank you for your $${donationAmount} donation!`)
        setTimeout(() => setNotification(null), 3000)
    ...
    <div className="container max-w-md mx-auto px-4 py-10">
      ...
      >
        <div className="relative">
          ...
          <div className="relative">
            <h1 className="text-3xl font-bold text-center">BetterWithin</h1>
            <p className="text-center text-muted-foreground">Your mental wellness journey</p>
          </div>
        </div>
      </motion.div>
        ...
        <TabsContent value="sign-in">
          <Card className="border-none shadow-lg">
            <CardHeader>
              ...
              <CardDescription>Sign in to your BetterWithin account</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="sign-up">
          <Card className="border-none shadow-lg">
            <CardHeader>
              ...
              <CardDescription>Join BetterWithin to start your wellness journey</CardDescription>
            </CardHeader>
            <CardContent>
